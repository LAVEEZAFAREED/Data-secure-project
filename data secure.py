...
if choice == "Home":
    ...
    st.markdown("""Develop a Streamlit_based secure data storage and retrieval system where: users store
     data with a unique passkey.Users decrypt data by providing the correct passkey.
      Multiple failed attempts result in a forced reauthorization (login page).The system operates entirely in memory
...
# === data store section ===
    ...
    if st.button("Encrypt And Save"):
        if data and passkey:
            ...
            st.error("All fields ae required to fill.")
    
    # === data reteive data section ===
        ...
        if st.button("Decrypt"):
            ...
            if result:
                ...
                st.error("❌ Incorrect passkey or corrrupted data.")
